	...
	return (
		<section className="bg-gray-800 rounded-xl p-6 shadow-md mb-8">
			<h2 className="text-xl font-semibold mb-4">
				🎯 Key Skill 4: Health Promotion Matching
			</h2>
			<p className="text-gray-300 mb-4">
				Drag each initiative into its correct Ottawa Charter action area. Click
				"Show Answers" for help or use "Reset" to try again.
			</p>
			<InitiativeDragDrop
				key={resetKey}
