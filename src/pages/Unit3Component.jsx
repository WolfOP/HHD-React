...
export default function Unit3Component() {
  return (
    <section className="content-section">
      ...
      <p><strong>Health and Wellbeing:</strong> For the VCE HHD study, 'health and wellbeing' is defined as the overall state of a person's physical, social, emotional, mental, and spiritual existence and is characterized by an equilibrium in which the individual feels happy, healthy, capable, and engaged.</p>
      <p>The World Health Organization (WHO) defined health in 1946 as "a state of complete physical, mental and social well-being and not merely the absence of disease or infirmity." This definition recognizes that health is more than the absence of disease and includes wellbeing in various areas of life.</p>
      ...
      <ul>
        <li><strong>Physical Health and Wellbeing:</strong> Relates to the functioning of the body and its systems, including the physical capacity to perform daily activities or tasks. It's supported by factors such as regular physical activity, consuming a balanced diet, having appropriate rest, maintaining a healthy body weight, and avoiding harmful substances.</li>
        <li><strong>Social Health and Wellbeing:</strong> Concerns the ability to form meaningful and satisfying relationships with others and to manage or adapt appropriately to different social situations.</li>
        <li><strong>Emotional Health and Wellbeing:</strong> Relates to the ability to express feelings in a positive way, manage emotional actions and reactions appropriately, and display resilience.</li>
        <li><strong>Mental Health and Wellbeing:</strong> Relates to the current state of the mind or brain and the ability to think and process information. It includes having positive self-esteem, confidence, and levels of stress and anxiety.</li>
        <li><strong>Spiritual Health and Wellbeing:</strong> Relates to ideas, beliefs, values, and ethics that arise in the minds and conscience of human beings. It includes concepts of hope, peace, a guiding sense of meaning or value, and reflection on a person's place in the world.</li>
      </ul>
      ...
      <ul>
        <li><strong>Dynamic:</strong> Health and wellbeing are constantly changing. Changes can occur rapidly due to various factors like illness, stress, or positive life events. An individual's health can improve or deteriorate over short periods of time.</li>
        <li><strong>Subjective:</strong> Health and wellbeing are influenced by personal opinions, beliefs, feelings, and experiences. How a person perceives their health can differ significantly from how others perceive it.</li>
      </ul>
      <hr className="my-6 border-slate-700" />
      
      <h3>2. Benefits of Optimal Health and Wellbeing as a Resource</h3>
      <p>Optimal health and wellbeing is not just an end goal; it's a vital resource that empowers individuals and benefits communities and the world at large. It's the foundation upon which people can realize their aspirations, satisfy needs, change or cope with the environment, and contribute to society.</p>
      ...
      <ul>
          ...
          <li><strong>Higher Average Incomes & Tax Revenue:</strong> A productive workforce earns more, leading to increased taxation revenue for the government. This revenue can be reinvested in essential services like education and healthcare.</li>
      ...
      <ul>
          <li><strong>Reduced Risk of Disease Transmission:</strong> Healthier populations are less susceptible to communicable diseases, reducing the risk of pandemics and cross-border infections (e.g., COVID-19, Ebola).</li>
      ...
      <p>For example, global efforts to eradicate diseases like polio not only save lives but also free up resources and enable affected populations to become more economically productive, benefiting the world economy.</p>
      <hr className="my-6 border-slate-700" />

      <h3>3. Indicators Used to Measure and Understand Health Status</h3>
      <p>Health status refers to an individual's or a population's overall level of health and wellbeing, taking into account various aspects such as life expectancy, amount of disability, and levels of disease risk factors.</p>
      ...
      <ul>
          ...
          <li>
              ...
              <p>Refers to death, particularly at a population level. The mortality rate is the number of deaths (usually per 100,000 people) in a population from a specific cause or all causes over a period of time.</p>
              <ul>
          ...
          <li>
              ...
              <p>An estimate of the average number of years that a person can expect to live in full health, by taking into account years lived with disability due to illness or injury. It is life expectancy adjusted for time spent in poor health.</p>
          </li>
          <li>
              <strong>Burden of Disease (BoD):</strong>
              <p>A measure of the impact of diseases and injuries. Specifically, it measures the gap between current health status and an ideal situation where everyone lives to an old age free of disease and disability. The main measure is the Disability-Adjusted Life Year (DALY).</p>
              <ul>
                  <li><strong>Disability-Adjusted Life Years (DALYs):</strong> One DALY represents one year of healthy life lost due to premature death (Years of Life Lost - YLL) and time lived with illness, disease or injury (Years Lived with Disability - YLD).</li>
                  ...
                  <li><strong>Years Lived with Disability (YLD):</strong> The non-fatal component of DALYs. It measures how many healthy years of life are lost due to living with the negative impacts (e.g., illness, injury, disability) of a disease or condition.</li>
              </ul>
          </li>
          <li>
      ...
      <p>Variations in health status exist between different population groups in Australia. These differences are often due to the complex interplay of biological, sociocultural, and environmental factors.</p>
      ...
      <ul>
          ...
          <li><strong>Birth Weight:</strong>
              <ul>
                  <li>Low birth weight (less than 2.5kg) is associated with a higher risk of developing health problems later in life, including cardiovascular disease and diabetes, and can also indicate poor growth during pregnancy.</li>
              </ul>
          </li>
      </ul>
      ...
      <ul>
          ...
          <li><strong>Food Security:</strong>
              <ul>
                  <li>The state in which all persons obtain nutritionally adequate, culturally appropriate, safe food regularly through local non-emergency sources. Lack of food security (food insecurity) can lead to malnutrition, stress, and poor health outcomes.</li>
              </ul>
          </li>
      ...
      <ul>
          <li><strong>Housing:</strong>
              <ul>
                  <li>Poor quality housing (e.g., overcrowding, dampness, lack of ventilation, presence of hazards like lead or asbestos) can increase the risk of respiratory diseases, injuries, and mental health problems.</li>
              </ul>
          </li>
          ...
          <li><strong>Urban Design and Infrastructure:</strong>
              <ul>
                  <li>Availability of public transport, green spaces (parks, recreational areas), walking and cycling paths, and proximity to shops and services can influence physical activity levels, access to resources, and social interactions.</li>
              </ul>
          </li>
          <li><strong>Geographical Location (Access to Resources/Transport):</strong>
              <ul>
                  <li>People living in rural and remote areas often have poorer access to healthcare services, healthy food options, educational opportunities, and employment compared to those in major cities.</li>
              </ul>
          </li>
      ...
      <p>Several specific, largely modifiable, lifestyle factors and behaviours significantly contribute to Australia's burden of disease and impact overall health status. Understanding these is crucial for developing effective public health strategies.</p>

      <h4>a) Smoking and Vaping</h4>
      <ul>
          <li><strong>Smoking (Tobacco):</strong> A leading preventable cause of death and disease in Australia.
              <ul>
                  <li>Increases the risk of numerous conditions including various cancers (lung, mouth, throat, stomach, bladder), cardiovascular disease (heart attack, stroke), respiratory diseases (emphysema, chronic bronchitis), and complications in pregnancy.</li>
      ...
      <p className="italic text-slate-400">This area of study examines different approaches to public health over time, focusing on changes and successful strategies that have improved health outcomes. It also investigates initiatives designed to promote health and wellbeing in Australia.</p>
      <h3>1. Reasons for Improvements in Australia's Health Status Since 1900</h3>
      <p>Australia's health status has significantly improved since 1900. Life expectancy has increased, and mortality rates, particularly for infants and young children, have declined dramatically. These improvements are the result of various public health interventions, advances in medical technology, and changing social, economic, and environmental conditions.</p>
      <h4>Overview of Health Status Shift:</h4>
      <p>In the early 1900s, infectious and parasitic diseases (like tuberculosis, polio, and smallpox) were the leading causes of death and illness. Over time, due to public health interventions and improved living conditions, chronic diseases such as cardiovascular disease, cancer, and diabetes have become more prevalent.</p>
      ...
      <p>This approach focuses on the physical or biological aspects of disease and illness. It is a medical model of care practiced by doctors and health professionals and is primarily associated with the diagnosis, cure, and treatment of disease.</p>
      <ul>
      ...
      <p><strong>Improvements in Medical Technology:</strong> Discoveries like vaccines (for polio, measles, tetanus), antibiotics (like penicillin to treat bacterial infections), and advancements in surgical techniques have saved countless lives and improved quality of life.</p>
      ...
      <p><strong>Limitations:</strong> Can be costly due to reliance on technology and professionals, doesn't always promote equity (not all can access), focuses on treatment rather than prevention, doesn't address broader social determinants.</p>
      <h4>c) The Social Model of Health (and the New Public Health)</h4>
      <p>Emerged in the late 20th century, recognizing that improvements in health and wellbeing cannot be achieved by focusing solely on treating individuals. It addresses the broader determinants of health (social, economic, environmental) and aims to prevent illness by promoting healthy behaviours and conditions.</p>
      <ul>
      ...
      <p><strong>Strengths:</strong> Promotes good health and wellbeing and assists in preventing diseases, relatively inexpensive (as it can reach large numbers), focuses on vulnerable population groups.</p>
      <p><strong>Limitations:</strong> Not all conditions can be prevented (e.g., genetic conditions), doesn't address health concerns of individuals (not a treatment model), health promotion messages may be ignored.</p>
      <h4>d) The Ottawa Charter for Health Promotion</h4>
      <p>Developed by the WHO in 1986, the Ottawa Charter provides a framework for health promotion. It builds upon the social model of health and outlines key action areas to achieve "Health For All".</p>
      <h4>Relationship between Biomedical and Social Models of Health:</h4>
      <p>Both the biomedical and social models are essential and often work together to achieve improvements in health status. The biomedical model is crucial for treating existing illnesses and conditions, while the social model aims to prevent them from occurring in the first place.</p>
      ...
      <p><strong>Health Promotion:</strong> According to the WHO, health promotion is the process of enabling people to increase control over, and to improve, their health. It goes beyond focusing on individual behaviour, addressing a wide range of social and environmental interventions.</p>
      <p>The Ottawa Charter for Health Promotion is a foundational framework for guiding health promotion efforts. It outlines five key action areas (strategies) to achieve health for all. These action areas can be remembered by the acronym "Bad Cats Smell Dead Rats":</p>
      <h4>The Five Action Areas of the Ottawa Charter:</h4>
      <h4>a) Build Healthy Public Policy (Bad)</h4>
      <p>This action area relates to the decisions made by governments and organisations regarding laws and policies that make it more difficult for people to undertake unhealthy behaviours and easier to engage in healthy behaviours.</p>
      <ul>
      ...
      <p>This action area aims to promote health and wellbeing by creating physical and social environments that are safe, stimulating, satisfying, and enjoyable. It recognizes the links between people and their environment.</p>
      <ul>
          <li><strong>Examples:</strong>
              <ul>
      ...
      <p>This action area is about supporting personal and social development through providing information, education for health, and enhancing life skills. This increases options available to people to make choices conducive to health.</p>
      <ul>
          <li><strong>Examples:</strong>
              <ul>
      ...
      <p>This action area aims to shift the health system and its components towards a focus on health promotion, rather than solely on curative services. It involves health professionals, community groups, and government working collaboratively to promote health.</p>
      <ul>
          <li><strong>Examples:</strong>
              <ul>
      ...
      <p>Addressing the health inequities experienced by Aboriginal and Torres Strait Islander peoples is a significant focus in Australia. Effective programs aim to be culturally appropriate, involve Indigenous people in decision-making, and reflect the principles of social justice and the Ottawa Charter.</p>
      ...
      <ul>
          ...
          <li><strong>Enable Participation:</strong> Involve Aboriginal and Torres Strait Islander peoples in the design, delivery, and evaluation of health programs that affect them. Community control is key.</li>
      </ul>
      ...
      <ul>
          <li><strong>National Aboriginal Community Controlled Health Organisation (NACCHO):</strong> The national peak body representing local ACCHSs. ACCHSs provide holistic, comprehensive, and culturally appropriate primary health care.</li>
          <li><strong>'Care for Kids' Ears' initiative:</strong> Addresses the high rates of otitis media (ear infections) in Indigenous children. It provides culturally appropriate information resources to families and health workers.</li>
          <li><strong>'Move it Mob Style' program:</strong> A dance-based fitness program for television and online platforms, showcasing Aboriginal and Torres Strait Islander music and dance, led by Indigenous youth role models.</li>
          <li><strong>'Aboriginal Road to Good Health' program:</strong> A Type 2 Diabetes prevention program that educates Indigenous people about healthy eating and lifestyles, reflecting the Develop Personal Skills and Strengthen Community Action areas.</li>
      </ul>
      ...
      <p>Promoting healthy eating is a key public health goal in Australia to address issues like overweight, obesity, and diet-related chronic diseases. Various initiatives provide guidance and support to individuals and communities.</p>
      <h4>Key Initiatives to Promote Healthy Eating:</h4>
      <ul>
          <li>
              <strong>The Australian Dietary Guidelines (ADGs):</strong>
              <p>Developed by the National Health and Medical Research Council (NHMRC), the ADGs provide evidence-based advice on the types and amounts of foods that Australians should eat for health and wellbeing. There are five main guidelines:</p>
              <ol className="list-decimal ml-6">
                  ...
                  <li>Enjoy a wide variety of nutritious foods from these five groups every day: plenty of vegetables (including different types and colours), and legumes/beans; fruit; grain (cereal) foods, mostly wholegrain and high cereal fibre varieties; lean meats and poultry, fish, eggs, tofu, nuts and seeds, and legumes/beans; milk, yoghurt, cheese and/or alternatives, mostly reduced fat.</li>
          ...
          <li>
              ...
              <p>A practical, visual food selection guide that reflects the Australian Dietary Guidelines. It presents a plate (circle graph) showing the proportions of the five food groups that should be consumed each day. It also advises limiting discretionary foods (those high in saturated fat, added salt, and added sugars).</p>
          </li>
          <li>
              <strong>The Healthy Eating Pyramid:</strong>
              <p>Developed by Nutrition Australia, this is another visual guide that layers foods according to the proportion in which they should be consumed. It encourages Australians to enjoy a variety of foods, and shows plant-based foods (vegetables, fruits, grains) as the foundation layers, followed by dairy and alternatives, then lean meats/poultry/fish/eggs/nuts/legumes, and healthy fats at the top in small amounts.</p>
          </li>
          <li>
              <strong>Nutrition Australia:</strong>
              <p>A non-government, non-profit, community-based organisation that aims to promote optimal health and wellbeing for all Australians by encouraging food variety and physical activity. Their initiatives include:</p>
              <ul>
      ...
      <ul>
          <li>
              ...
              <ul>
                  <li><strong>Food marketing and media:</strong> Extensive marketing of energy-dense, nutrient-poor foods, especially to children and young people, can heavily influence food choices.</li>
      ...
      <p>Australia's health system is a complex network of public and private services and providers. It aims to promote, restore, or maintain health for all Australians. Key components include Medicare, the Pharmaceutical Benefits Scheme (PBS), private health insurance, and the National Disability Insurance Scheme (NDIS).</p>
      <h4>a) Medicare</h4>
      ...
      <ul>
          <li><strong>Funding:</strong>
              <ul>
                  ...
                  <li><strong>Medicare Levy Surcharge (MLS):</strong> An additional levy (1-1.5%) on higher-income earners who do not have an appropriate level of private hospital insurance. This aims to encourage people to take out private health insurance and reduce pressure on the public system.</li>
                  <li><strong>General Taxation:</strong> The revenue collected from the levy and surcharge does not cover the full cost of Medicare, so a significant portion is funded from general income tax.</li>
              </ul>
          </li>
          ...
          <li><strong>Services Covered:</strong> GP consultations, specialist consultations (partial), tests and examinations (e.g., X-rays, blood tests), most surgical procedures performed by doctors, some eye tests by optometrists, and accommodation and treatment as a public patient in a public hospital.</li>
          <li><strong>Services NOT Covered (typically):</strong> Most dental examinations and treatment, ambulance services, home nursing, physiotherapy, chiropractic services, cosmetic surgery, hearing aids, glasses, and some alternative therapies.</li>
      </ul>
      <h4>b) Private Health Insurance (PHI)</h4>
      <p>PHI is an optional additional health insurance that individuals can choose to purchase to cover health services not fully covered by Medicare, or to access private hospital care. It gives individuals more choice and can reduce waiting times for elective surgeries.</p>
      <ul>
          <li><strong>Funding:</strong> Funded by individuals through premiums paid to private health insurance companies. The government also provides a private health insurance rebate (income-tested) to encourage people to take out PHI.</li>
          <li><strong>Sustainability:</strong>
              <ul>
          ...
          <li><strong>Equity:</strong>
              <ul>
                  ...
                  <li>However, it can also create inequities, as access to these additional benefits is largely dependent on the ability to pay premiums. The government rebate aims to improve affordability.</li>
              </ul>
          </li>
      </ul>
      ...
      <ul>
          ...
          <li><strong>Sustainability:</strong>
              <ul>
                  <li>The Pharmaceutical Benefits Advisory Committee (PBAC) assesses medicines for clinical effectiveness and cost-effectiveness before they are listed on the PBS. This helps ensure sustainability and value for money.</li>
      ...
      <p>The NDIS is a national scheme that provides support to Australians under 65 years of age who have a permanent and significant disability. It aims to help people with disability achieve their goals and participate fully in life.</p>
      <ul>
          ...
          <li><strong>Access:</strong>
              <ul>
                  <li>Provides access to reasonable and necessary supports based on individual needs and goals. This can include assistive technology, personal care, therapy services, help with housing or employment, and social participation.</li>
      ...
      <p className="mt-6 text-slate-400 text-sm">
        <em>
          For detailed interactive activities, visit the Key Skills Hub and Unit 3
          SAC 2 Prep pages. Always refer to your Study Design and official VCAA
          resources for assessment requirements.
        </em>
      </p>
    </section>
  );
