...
function App() {
  ...
  return (
    <Router>
      ...
      <div className="font-sans antialiased min-h-screen bg-white text-slate-800 dark:bg-slate-900 dark:text-slate-200 transition-colors">
        <header className="bg-gray-100 dark:bg-slate-800 shadow-lg sticky top-0 z-50 transition-colors">
          <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
            <Link to="/" className="text-2xl font-bold text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 transition-colors">HHD Hub</Link>
            ...
            <ul className="hidden md:flex space-x-4">
              <li><Link to="/" className="nav-link hover:text-purple-300 px-3 py-2 rounded-md transition-colors">Home</Link></li>
              <li><Link to="/unit3" className="nav-link hover:text-purple-300 px-3 py-2 rounded-md transition-colors">Unit 3</Link></li>
              <li><Link to="/unit4" className="nav-link hover:text-purple-300 px-3 py-2 rounded-md transition-colors">Unit 4</Link></li>
              <li><Link to="/assessment-prep" className="nav-link hover:text-purple-300 px-3 py-2 rounded-md transition-colors">Assessment Prep</Link></li>
              <li><Link to="/glossary" className="nav-link hover:text-purple-300 px-3 py-2 rounded-md transition-colors">Glossary</Link></li>
            </ul>
          </nav>
          {mobileMenuOpen && (
            <div className="md:hidden bg-slate-800">
              <ul className="flex flex-col items-center py-2 space-y-2">
                ...
                <li><Link to="/" onClick={() => setMobileMenuOpen(false)} className="transition-colors hover:text-purple-300">Home</Link></li>
                <li><Link to="/unit3" onClick={() => setMobileMenuOpen(false)} className="transition-colors hover:text-purple-300">Unit 3</Link></li>
                <li><Link to="/unit4" onClick={() => setMobileMenuOpen(false)} className="transition-colors hover:text-purple-300">Unit 4</Link></li>
                <li><Link to="/assessment-prep" onClick={() => setMobileMenuOpen(false)} className="transition-colors hover:text-purple-300">Assessment Prep</Link></li>
                <li><Link to="/glossary" onClick={() => setMobileMenuOpen(false)} className="transition-colors hover:text-purple-300">Glossary</Link></li>
              </ul>
            </div>
          )}
        </header>
        ...
        <footer className="bg-gray-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-center p-6 shadow-top transition-colors">
